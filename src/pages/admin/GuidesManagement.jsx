...
export default function GuidesManagement() {
  ...
  return (
    <>
      <Helmet>
        <title>Guides Management - Admin</title>
        <meta name="description" content="Manage downloadable guides" />
      </Helmet>
              ...
              <tbody>
                {filteredGuides.map(guide => (
                  <tr key={guide.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 text-sm">{guide.category}</td>
                    <td className="px-4 py-2 text-sm">{guide.downloads || 0}</td>
